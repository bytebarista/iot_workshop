...
class Area:
    def __init__(self, disp):
        ...
        # The whole width, max block size 4x4 + 1 buffer over
        self.buffer = bytearray(self.blocksize * self.asizex * self.blocksize * 5 * 2)
        ...
        self.colors = [color565(0, 0, 0), color565(200, 0, 0), color565(0, 200, 0), color565(0, 0, 200),
                       color565(150, 150, 0), color565(150, 150, 150), color565(150, 0, 150),
                       color565(200, 150, 50), color565(50, 250, 150), color565(50, 50, 50)]
    ...
    def rotateblock(self, direction):
        ...
        if self.ablocksid == 5:  # can't rotate a cube
            self.ablocksflipped = 0
...
def run():
    ...
    while not area.gg:
        ...
        if not io.input(PIN_DOWN) or not io.input(BUTTON_DOWN):
            area.boost()
